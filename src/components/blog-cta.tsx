...
export function BlogCta() {
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, oklch(0.20 0.06 170) 0%, oklch(0.18 0.08 175) 100%)",
        border: "1px solid oklch(0.35 0.10 170)",
      }}
    >
      <p
      ...
      <p className="text-white/60 text-base sm:text-lg max-w-md mx-auto mb-8 leading-relaxed">
